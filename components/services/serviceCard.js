...
const ServiceCard = ({ title, description, icon }) => {
  return (
      ...
      <div className="rounded-2xl bg-white  shadow-sm p-5 flex flex-col  items-center w-xs h-60 transition-transform duration-300 hover:scale-105 cursor-pointer">
